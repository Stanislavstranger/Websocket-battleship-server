	...
	var e = {
			...
			448: (e, t, n) => {
				...
				function Qt(e, t) {
					e.blockedOn === t &&
						((e.blockedOn = null),
						Mt || ((Mt = !0), o.unstable_scheduleCallback(o.unstable_NormalPriority, Ut)));
				}
				function Bt(e) {
					function t(t) {
						return Qt(t, e);
					...
					for (; 0 < At.length && null === (n = At[0]).blockedOn; )
						_t(n), null === n.blockedOn && At.shift();
				}
				...
				function Yt(e, t, n, r) {
					if (Ht) {
						var o = Zt(e, t, n, r);
						if (null === o) Hr(e, t, r, Gt, n), Tt(e, r);
						else if (
							(function (e, t, n, r, o) {
								switch (t) {
									case 'focusin':
							...
							for (; null !== o; ) {
								...
								if (
									(null !== a && St(a),
									null === (a = Zt(e, t, n, r)) && Hr(e, t, r, Gt, n),
									a === o)
								)
									break;
								o = a;
				...
				var an,
					...
					gn = on(_({}, fn, { relatedTarget: 0 })),
					yn = on(_({}, sn, { animationName: 0, elapsedTime: 0, pseudoElement: 0 })),
					vn = _({}, sn, {
				...
				var Mn = _({}, fn, {
					...
					Pn = on(_({}, sn, { propertyName: 0, elapsedTime: 0, pseudoElement: 0 })),
					zn = _({}, pn, {
						deltaX: function (e) {
							...
							if (void 0 !== l) {
								...
								for (var p, h = r; null !== h; ) {
									...
									if (
										(5 === p.tag &&
											null !== m &&
											((p = m), null !== d && null != (m = je(h, d)) && c.push(Vr(h, m, p))),
										f)
									)
										break;
									h = h.return;
							...
							b &&
								(_n &&
									...
									(Bn || 'onCompositionStart' !== b
										...
										: ((qt = 'value' in (Kt = o) ? Kt.value : Kt.textContent), (Bn = !0))),
								0 < (y = $r(r, b)).length &&
					...
					switch (e.tag) {
						...
						case 13:
							return (
								...
								((n = null !== Jo ? { id: Ko, overflow: qo } : null),
				...
				var Ba = {
					...
					enqueueSetState: function (e, t, n) {
						...
						(a.payload = t),
							null != n && (a.callback = n),
							null !== (t = Ta(e, a, o)) && (ns(t, e, o, r), La(t, e, o));
					},
					...
					enqueueForceUpdate: function (e, t) {
						...
						(o.tag = 2),
							null != t && (o.callback = t),
							null !== (t = Ta(e, o, r)) && (ns(t, e, r, n), La(t, e, r));
					},
				};
				...
				function Ha(e, t, n) {
					...
					return (
						'object' == typeof a && null !== a
							? (a = Ma(a))
							: ((o = Ao(t) ? zo : Do.current),
								(a = (r = null != (r = t.contextTypes)) ? jo(e, o) : No)),
						(t = new t(n, a)),
				...
				function $a(e, t, n, r) {
					...
					'object' == typeof a && null !== a
						? (o.context = Ma(a))
						: ((a = Ao(t) ? zo : Do.current), (o.context = jo(e, a))),
				...
				function Ja(e) {
					...
					function s(e, t, n, r) {
						...
						return a === k
							...
							: null !== t &&
								  (t.elementType === a ||
										('object' == typeof a && null !== a && a.$$typeof === j && Za(a) === t.type))
								? (((r = o(t, n.props)).ref = Ya(e, t, n)), (r.return = e), r)
								: (((r = Is(n.type, n.key, n.props, null, e.mode, r)).ref = Ya(e, t, n)),
									(r.return = e),
									r);
					}
					function c(e, t, n, r) {
					...
					function d(e, t, n) {
						...
						if ('object' == typeof t && null !== t) {
							switch (t.$$typeof) {
								case S:
									return (
										((n = Is(t.type, t.key, t.props, null, e.mode, n)).ref = Ya(e, null, t)),
										(n.return = e),
										n
									);
								case x:
							...
							switch (i.$$typeof) {
								case S:
									e: {
										...
										i.type === k
											? (((a = Ts(i.props.children, r.mode, u, i.key)).return = r), (r = a))
											: (((u = Is(i.type, i.key, i.props, null, r.mode, u)).ref = Ya(r, a, i)),
												(u.return = r),
												(r = u));
									}
									return l(r);
				...
				function ji(e, t) {
					...
					if (
						...
						(r = r.queue),
						Hi(Ti.bind(null, n, r, e), [e]),
						r.getSnapshot !== t || i || (null !== yi && 1 & yi.memoizedState.tag))
					) {
						if (((n.flags |= 2048), Fi(9, Ii.bind(null, n, r, o, t), void 0, null), null === Du))
							throw Error(a(349));
						0 != (30 & hi) || Ai(n, t, o);
					}
					return o;
				...
				function qi(e, t, n) {
					return 0 == (21 & hi)
						...
						: (lr(n, t) || ((n = mt()), (mi.lanes |= n), (Lu |= n), (e.baseState = !0)), t);
				}
				function Xi(e, t) {
					var n = bt;
					(bt = 0 !== n && 4 > n ? n : 4), e(!0);
				...
				function Nl(e, t, n, r, o) {
					...
					if ((Ca(t, o), null === t.stateNode)) Wl(e, t), Ha(t, n, r), $a(t, n, r, o), (r = !0);
					else if (null === e) {
						var i = t.stateNode,
							l = t.memoizedProps;
						i.props = l;
						...
						(i.state = d),
							Ra(t, r, i, o),
							(u = t.memoizedState),
							l !== r || d !== u || Po.current || za
								? ('function' == typeof c && (Qa(t, n, c, r), (u = t.memoizedState)),
									(l = za || Wa(t, n, l, r, d, u, s))
										? (f ||
						...
						l !== f || d !== h || Po.current || za
							? ('function' == typeof p && (Qa(t, n, p, r), (h = t.memoizedState)),
								(s = za || Wa(t, n, s, r, d, h, u) || !1)
									? (c ||
				...
				function _l(e, t, n) {
							...
							if (n)
								return 256 & t.flags
									...
									: null !== t.memoizedState
										...
										: ((i = r.fallback),
											(o = t.mode),
											(r = Ls({ mode: 'visible', children: r.children }, o, 0, null)),
											((i = Ts(i, o, l, null)).flags |= 2),
											(r.return = t),
											(i.return = t),
											(r.sibling = i),
											(t.child = r),
					...
					if (l) {
						...
						return (
							...
							null !== r ? (l = As(r, l)) : ((l = Ts(l, u, n, null)).flags |= 2),
							(l.return = t),
							(o.return = t),
							(o.sibling = l),
							(t.child = o),
				...
				function Rl(e, t) {
					return (
						((t = Ls({ mode: 'visible', children: t }, e.mode, 0, null)).return = e), (e.child = t)
					);
				}
				function Fl(e, t, n, r) {
					return (
					...
					switch ((na(t), t.tag)) {
									...
									for (var u in (ve(n, i), (o = null), i))
										if (i.hasOwnProperty(u)) {
											...
											'children' === u
												? 'string' == typeof s
													? r.textContent !== s &&
														(!0 !== i.suppressHydrationWarning && qr(r.textContent, s, e),
														(o = ['children', s]))
													: 'number' == typeof s &&
														r.textContent !== '' + s &&
														(!0 !== i.suppressHydrationWarning && qr(r.textContent, s, e),
						...
						case 13:
							...
							return 0 != (128 & t.flags)
								...
								: ((r = null !== r) != (null !== e && null !== e.memoizedState) &&
										...
										((t.child.flags |= 8192),
										0 != (1 & t.mode) &&
											(null === e || 0 != (1 & ui.current) ? 0 === Iu && (Iu = 3) : ms())),
						...
						case 23:
							return (
								...
								r && 0 != (1 & t.mode)
									? 0 != (1073741824 & ju) && ($l(t), 6 & t.subtreeFlags && (t.flags |= 8192))
									: $l(t),
								null
							);
						case 24:
						...
						(e = e.stateNode),
							t
								...
								: (8 === n.nodeType
										...
										: (t = n).appendChild(e),
									null != (n = n._reactRootContainer) || null !== t.onclick || (t.onclick = Xr));
				...
				function pu(e, t, n) {
					...
					switch (n.tag) {
						...
						case 15:
							...
							break;
						case 1:
							if (!Jl && (Xl(n, t), 'function' == typeof (r = n.stateNode).componentWillUnmount))
								try {
					...
					switch (e.tag) {
						...
						case 22:
							if (
								...
								1 & e.mode ? ((Jl = (c = Jl) || f), mu(t, e), (Jl = c)) : mu(t, e),
								yu(e),
								8192 & r)
							) {
								if (
				...
				function ns(e, t, n, r) {
					...
					yt(e, n, r),
						(0 != (2 & Nu) && e === Du) ||
							(e === Du && (0 == (2 & Nu) && (_u |= n), 4 === Iu && ls(e, zu)),
							rs(e, r),
							1 === n && 0 === Nu && 0 == (1 & t.mode) && ((Bu = Ke() + 500), Uo && Wo()));
				}
				function rs(e, t) {
				...
				function os(e, t) {
					...
					if (0 != (30 & r) || 0 != (r & e.expiredLanes) || t) t = gs(e, r);
						...
						Nu |= 2;
						var i = hs();
						for ((Du === e && zu === t) || ((Wu = null), (Bu = Ke() + 500), ds(e, t)); ; )
							try {
								vs();
								break;
							} catch (t) {
						...
						xa(),
							(Cu.current = i),
							(Nu = o),
							null !== Pu ? (t = 0) : ((Du = null), (zu = 0), (t = Iu));
					}
					if (0 !== t) {
						if ((2 === t && 0 !== (o = ht(e)) && ((r = o), (t = as(e, o))), 1 === t))
							throw ((n = Tu), ds(e, 0), ls(e, r), rs(e, Ke()), n);
						if (6 === t) ls(e, r);
						else {
							if (
				...
				function ls(e, t) {
					for (
						t &= ~Ru, t &= ~_u, e.suspendedLanes |= t, e.pingedLanes &= ~t, e = e.expirationTimes;
						0 < t;
				...
				function ms() {
					(0 !== Iu && 3 !== Iu && 2 !== Iu) || (Iu = 4),
						null === Du || (0 == (268435455 & Lu) && 0 == (268435455 & _u)) || ls(Du, zu);
				}
				function gs(e, t) {
					var n = Nu;
					Nu |= 2;
					var r = hs();
					for ((Du === e && zu === t) || ((Wu = null), ds(e, t)); ; )
						try {
							ys();
							break;
						} catch (t) {
								...
								if (
									...
									(Nu |= 4),
										...
										(function (e, t) {
											...
											for (
												to = { focusedElem: e, selectionRange: n }, Ht = !1, ql = t;
												null !== ql;
																		...
																		if (null !== m) {
																			var g = m.memoizedProps,
																				...
																				b = v.getSnapshotBeforeUpdate(
																					t.elementType === t.type ? g : ya(t.type, g),
																					y,
																				);
					...
					if (null !== Gu) {
						...
						try {
							if (((Ou.transition = null), (bt = 16 > e ? 16 : e), null === Gu)) var r = !1;
								...
								if (((Nu = o), Wo(), at && 'function' == typeof at.onPostCommitFiberRoot))
									try {
				...
				function Cs(e, t, n) {
					...
					null !== r && r.delete(t),
						...
						Du === e &&
							(zu & n) === n &&
							(4 === Iu || (3 === Iu && (130023424 & zu) === zu && 500 > Ke() - Qu)
								? ds(e, 0)
								: (Ru |= n)),
						rs(e, t);
				}
				...
				function Hs(e, t, n, r) {
					...
					return (
						...
						null !== (e = Ta(o, t, i)) && (ns(e, o, i, a), La(e, o, i)),
						i
					);
				}
				function Vs(e) {
						...
						switch (e.tag) {
							case 3:
								...
								if (t.current.memoizedState.isDehydrated) {
									...
									0 !== n &&
										(vt(t, 1 | n), rs(t, Ke()), 0 == (6 & Nu) && ((Bu = Ke() + 500), Wo()));
								}
								break;
							case 13:
								cs(function () {
					...
					(t.unstable_scheduleCallback = function (e, o, a) {
						...
						return (
							...
							a > i
								? ((e.sortIndex = a),
									n(c, e),
									null === r(s) && e === r(c) && (g ? (v(M), (M = -1)) : (g = !0), I(S, a - i)))
	...
	(n.n = (e) => {
		...
		(() => {
			...
			var C = (function () {
				...
				return (
					(e.prototype.setCanvasBackground = function () {
			...
			const D = (function (e) {
				function t(t, n, r, o, a) {
					...
					return (
						(i.canvasSection = new M(t, 'canvas', 'canvas')),
						(i.ctx = i.canvasSection.node.getContext('2d')),
						(i.cellSize = o),
						(i.canvasSection.node.width = r * o),
						(i.canvasSection.node.height = n * o),
						(i.imagesData = a),
						i
					);
				}
				return (
					...
					(t.prototype.drawBoard = function (e) {
						var t = this;
						this.ctx.drawImage(
							this.imagesData.bgImg,
							0,
							0,
							this.canvasSection.node.width,
							this.canvasSection.node.height,
						),
					...
					(t.prototype.drawShips = function (e) {
						...
						null == e ||
							e.forEach(function (e) {
								var n = e.isRotate ? 'vertical' : 'horizont',
									r = t.imagesData[n][e.type];
			...
			var P = (function () {
				...
				z = (function () {
					...
					return (
						(e.prototype.getCurrentCell = function (e, t) {
						...
						(t.prototype.drawBoard = function () {
							...
							this.board.forEach(function (t, n) {
								t.forEach(function (t, r) {
									(e.ctx.fillStyle = 'rgba(255, 20, 20, 0.2)'),
										e.ctx.fillRect(
											e.inPixels(r) + 1,
											e.inPixels(n) + 1,
											e._cellSize - 2,
				...
				A = (function (e) {
					...
					return (
						P(t, e),
						(t.prototype.isOnBoard = function (e, t, n, r) {
							return r
								? t + n <= this.matrixLength() && e < this.matrixLength() && t >= 0 && e >= 0
								: e + n <= this.matrixLength() && t < this.matrixLength() && t >= 0 && e >= 0;
						}),
				...
				T = (function (e) {
					function t(t) {
						...
						return (
							...
							(n._cellSize = 30),
							(n.hoveredCells = []),
							(n.boardMatrixFullValue = 1),
							(n.boardMatrixBlockedCell = 5),
							(n.boardMatrixHoverValue = 2),
							(n.boardMatrixEmptyValue = 0),
							(n.boardOccupateValue = 7),
							n
						);
					}
					return (
						P(t, e),
						(t.prototype.fillCell = function (e, t, n, r, o) {
						...
						(t.prototype.defineCellValue = function (e) {
							return 'occupate' === e
								? this.boardOccupateValue
								: 'hovered' === e
									? this.boardMatrixHoverValue
									: 99;
						}),
						(t.prototype.fillCells = function (e, t, n, r, o) {
							...
							if (i.length === r)
								for (u = 0; u < i.length; u++) {
									var c = o ? n + u : n;
									(s = o ? t : t + u),
										this.board[c][s] !== this.boardMatrixBlockedCell &&
											l.push(''.concat(c, '-').concat(s));
								}
			...
			const F = function (e) {
					function t(e, r, u, s, d) {
						for (
								...
								switch (h) {
									case 123:
										...
										if (
											...
											if (
												((F = (m = t(r, _, m, h, d + 1)).length),
												0 < A &&
													((w = l(3, m, (_ = n(z, B, R)), r, N, O, F, h, d, s)),
													(B = _.join('')),
									...
									case 125:
									case 59:
										if (1 < (F = (B = (0 < _ ? B.replace(f, '') : B).trim()).length))
											switch (
												(0 === I &&
													((p = B.charCodeAt(0)), 45 === p || (96 < p && 123 > p)) &&
													(F = (B = B.replace(' ', ':')).length),
												0 < A &&
													void 0 !== (w = l(1, B, r, e, N, O, W.length, s, d, s)) &&
													0 === (F = (B = w.trim()).length) &&
													(B = '\0\0'),
												(p = B.charCodeAt(0)),
												(h = B.charCodeAt(1)),
							...
							switch (h) {
								...
								case 10:
									47 === k
										? (k = 0)
										: 0 === 1 + p && 107 !== s && 0 < B.length && ((_ = 1), (B += '\0')),
										0 < A * T && l(0, B, r, e, N, O, W.length, s, d, s),
										(O = 1),
										N++;
									break;
								case 59:
												...
												switch (k) {
													...
													case 42:
														47 === h &&
															42 === M &&
															F + 2 !== L &&
															(33 === u.charCodeAt(F + 2) && (W += u.substring(F, L + 1)),
															(g = ''),
															(k = 0));
												}
									}
						...
						if (0 < (F = W.length)) {
							if (
								((_ = r),
								0 < A && void 0 !== (w = l(2, W, _, e, N, O, F, s, d, s)) && 0 === (W = w).length)
							)
								return V + W + H;
							if (((W = _.join(',') + '{' + W + '}'), 0 != P * D)) {
					...
					function a(e, t) {
						...
						return (
							(n = e.substring(n + 1, e.length - 1)), I(2 !== t ? r : r.replace(E, '$1'), n, t)
						);
					}
					function i(e, t) {
					...
					function u(e) {
						return (
							void 0 !== (e = e.prefix) &&
								((I = null), e ? ('function' != typeof e ? (P = 1) : ((P = 2), (I = e))) : (P = 0)),
							u
						);
					}
					function s(e, n) {
						...
						var a = t(z, r, n, 0, 0);
						return (
							0 < A && void 0 !== (o = l(-2, a, r, r, N, O, a.length, 0, 0, 0)) && (a = o),
							(D = 0),
							(O = N = 1),
							a
						);
			...
			const W = Q(function (e) {
				return (
					B.test(e) || (111 === e.charCodeAt(0) && 110 === e.charCodeAt(1) && e.charCodeAt(2) < 91)
				);
			});
			function H() {
				return (H =
			...
			var ne = (function () {
				...
				ve = X,
				be = { isServer: !X, useCSSOMInjection: !ee },
				we = (function () {
					function e(e, t, n) {
						void 0 === e && (e = G),
							void 0 === t && (t = {}),
								...
								(function (e) {
									for (var t = document.querySelectorAll(se), n = 0, r = t.length; n < r; n++) {
										...
										o &&
											...
											(de(e, o), o.parentNode && o.parentNode.removeChild(o));
									}
								})(this));
					}
						...
						(t.getTag = function () {
							return (
								...
								(this.tag =
									...
									(o = t.target),
									(e = n ? new ye(o) : r ? new me(o) : new ge(o)),
									new ne(e)))
							);
							var e, t, n, r, o;
						}),
			...
			var Oe = Ce('5.3.6'),
				Ne = (function () {
					function e(e, t, n) {
						(this.rules = e),
							(this.staticRulesId = ''),
							(this.isStatic = (void 0 === n || n.isStatic) && Me(e)),
							(this.componentId = t),
							(this.baseHash = Ee(Oe, t)),
							(this.baseStyle = n),
							we.registerId(t);
					}
					return (
						(e.prototype.generateAndInjectStyles = function (e, t, n) {
							...
							if (
								...
								for (
									var u = this.rules.length, s = Ee(this.baseHash, n.hash), c = '', f = 0;
									f < u;
									f++
								) {
									var d = this.rules[f];
			...
			var je = e.createContext(),
				Ae = (je.Consumer, e.createContext()),
				Ie = (Ae.Consumer, new we()),
				Te = ze();
			function Le() {
			...
			function _e(t) {
				...
				return (
					...
					e.createElement(
						je.Provider,
						{ value: i },
						e.createElement(Ae.Provider, { value: l }, t.children),
					)
				);
			}
			var Re = (function () {
								...
								: $(e)
									? (function e(t, n) {
											...
											for (var i in t)
												t.hasOwnProperty(i) &&
													!He(t[i]) &&
													((Array.isArray(t[i]) && t[i].isCss) || Z(t[i])
														? a.push(We(i) + ':', t[i], ';')
														: $(t[i])
			...
			function ot(t, n, r) {
				var o = K(t),
					...
					d =
						n.displayName && n.componentId
							? Je(n.displayName) + '-' + n.componentId
							: n.componentId || s,
				...
				o &&
					...
					(h = n.shouldForwardProp
						...
						: t.shouldForwardProp);
				var g,
					y = new Ne(r, d, o ? t.componentStyle : void 0),
					...
					b = function (t, n) {
						return (function (t, n, r, o) {
							var a = t.attrs,
								...
								m = (function (t, n, r, o) {
									var a = Le(),
										i = (0, e.useContext)(Ae) || Te;
									return n
										? t.generateAndInjectStyles(G, a, i)
										: t.generateAndInjectStyles(r, a, i);
								})(i, o, p),
								g = r,
							...
							for (var S in b)
								'$' !== S[0] &&
									...
									('forwardedAs' === S
										? (w.as = b[S])
										: (s ? s(S, W, y) : !v || W(S)) && (w[S] = b[S]));
							return (
								n.style && h.style !== n.style && (w.style = H({}, n.style, {}, h.style)),
					...
					return (
						...
						(o.attrs = function (o) {
							return e(
								t,
								n,
								H({}, r, { attrs: Array.prototype.concat(r.attrs, o).filter(Boolean) }),
							);
						}),
						o
					);
				...
				(function () {
					var e = function (e, t) {
						(this.rules = e),
							(this.componentId = t),
							(this.isStatic = Me(e)),
							we.registerId(this.componentId + 1);
					}.prototype;
					(e.createStyles = function (e, t, n, r) {
						...
						(e.renderStyles = function (e, t, n, r) {
							e > 2 && we.registerId(this.componentId + e),
				...
				(function () {
					var t = function () {
						...
						(this._emitSheetCSS = function () {
							...
							return (
								'<style ' +
								[n && 'nonce="' + n + '"', q + '="true"', 'data-styled-version="5.3.6"']
									.filter(Boolean)
									.join(' ') +
								'>' +
								e +
							...
							(this.instance = new we({ isServer: !0 })),
							(this.sealed = !1);
					}.prototype;
			...
			var lt,
				...
				xt = it.p(
					Et ||
						...
						Object.defineProperty ? Object.defineProperty(lt, 'raw', { value: ut }) : (lt.raw = ut),
						(Et = lt)),
					ht,
					function (e) {
						return e.textAlign;
			...
			var Pt,
				zt = (function () {
					function e(e, t, n, r, o) {
						...
						(this.img = new Image()),
							(this.img.src =
								'miss' === o ? './public/assets/water2.png' : './public/assets/explosion.png'),
							(this.curFrame = 0),
							(this.cellSize = r),
							(this.y = e),
							(this.x = t),
					...
					return (
						(e.prototype.inPixels = function (e) {
							return e * this.cellSize;
						}),
						...
						(e.prototype.draw = function (e) {
							this.ctx.clearRect(
								this.inPixels(this.x),
								this.inPixels(this.y),
								this.cellSize,
								this.cellSize,
							),
								this.ctx.drawImage(
									...
									this.img.width / 6,
									this.img.height,
									this.inPixels(this.x) || 0,
									this.inPixels(this.y) || 0,
									this.cellSize,
									this.cellSize,
								);
						}),
				...
				It = (function (e) {
					function t(t, n, r) {
						...
						return (
							(o.node.width = n),
							(o.node.height = r),
							(o.hashedCells = new Map()),
							(o.ctx = o.node.getContext('2d')),
							(o.board = new Array(10).fill(new Array(10).fill(0))),
							(o.spriteMatrix = new j(o.board, o.ctx)),
					...
					return (
						At(t, e),
						(t.prototype.upDateOccupied = function (e) {
			...
			function Rt(e) {
				...
				return (
					...
					((function (e) {
						...
						Array.isArray(e) ||
						!!e[kn] ||
						!!(null === (t = e.constructor) || void 0 === t ? void 0 : t[kn]) ||
						Ht(e) ||
						Vt(e))
				);
			}
			...
			function Gt(e, t) {
				return (
					...
					Jt(e) ||
						_t(e) ||
						!Rt(e) ||
						(Ut(e) > 1 && (e.set = e.add = e.clear = e.delete = Zt),
						Object.freeze(e),
						t &&
							Ft(
								e,
			...
			function on(e, t) {
				...
				var n = t.p[0],
					r = void 0 !== e && e !== n;
				return (
					t.h.g || Kt('ES5').S(t, e, r),
					r
						? (n[En].P && (en(t), Lt(4)),
							Rt(e) && ((e = an(t, e)), t.l || un(t, e)),
							t.u && Kt('Patches').M(n[En].t, e, t.u, t.s))
						: (e = an(t, n, [])),
					en(t),
					t.u && t.v(t.u, t.s),
					e !== xn ? e : void 0
			...
			var gn,
				yn,
				vn = 'undefined' != typeof Symbol && 'symbol' == typeof Symbol('x'),
				bn = 'undefined' != typeof Map,
				...
				Dn = {
					...
					deleteProperty: function (e, t) {
						return (
							void 0 !== sn(e.t, t) || t in e.t ? ((e.R[t] = !1), dn(e), fn(e)) : delete e.R[t],
							e.o && delete e.o[t],
							!0
						);
					},
					...
					function e(e) {
						...
						(this.g = Sn),
							...
							(this.produce = function (e, n, r) {
								...
								var i;
								if (
									('function' != typeof n && Lt(6),
									void 0 !== r && 'function' != typeof r && Lt(7),
									Rt(e))
								) {
									var l = nn(t),
										u = pn(t, e, void 0),
			...
			function Hn(e, t, n) {
				...
				return (
					d({ type: Bn.INIT }),
					((r = { dispatch: d, subscribe: f, getState: c, replaceReducer: p })[Un] = h),
					r
				);
			}
			function Vn() {
			...
			var Jn = (function () {
				...
				ar = function (e, t) {
					...
					if (tr)
						for (var r = 0, o = tr(t); r < o.length; r++)
							(n = o[r]), rr.call(t, n) && or(e, n, t[n]);
					return e;
				},
				ir = function (e, t) {
					return Xn(e, er(t));
					...
					'undefined' != typeof window && window.__REDUX_DEVTOOLS_EXTENSION_COMPOSE__
						...
						: function () {
								if (0 !== arguments.length)
									return 'object' == typeof arguments[0] ? Vn : Vn.apply(null, arguments);
							};
			'undefined' != typeof window &&
			...
			function cr(e, t) {
				function n() {
					...
					if (t) {
						...
						return ar(
							ar({ type: e, payload: o.payload }, 'meta' in o && { meta: o.meta }),
			...
			function dr(e) {
				...
				var n,
					r = 'function' == typeof e.initialState ? e.initialState : sr(e.initialState),
					o = e.reducers || {},
					a = Object.keys(o),
					i = {},
					l = {},
					u = {};
				function s() {
					var t = 'function' == typeof e.extraReducers ? fr(e.extraReducers) : [e.extraReducers],
						n = t[0],
						o = void 0 === n ? {} : n,
						a = t[1],
						i = void 0 === a ? [] : a,
			...
			var pr = ['name', 'message', 'stack', 'code'],
				hr = function (e, t) {
			...
			!(function () {
				function e(e, t, n) {
					var r = cr(e + '/fulfilled', function (e, t, n, r) {
							return {
								payload: e,
								meta: ir(ar({}, r || {}), { arg: n, requestId: t, requestStatus: 'fulfilled' }),
							};
						}),
											...
											return (function (e, t) {
												...
												switch (b.label) {
													...
													case 4:
														return (
															(v = b.sent()),
															(m = v instanceof hr ? a(null, f, e, v.payload, v.meta) : a(v, f, e)),
															[3, 5]
														);
													case 5:
														return (
											...
											if (t && 'object' == typeof t) {
												...
												if (n) {
													...
													if (4 === l)
														...
														if ((r(n) && (fn(n), (i.length = !0)), a.length < o.length))
			...
			var wr = dr({
				...
				kr = Sr.fillCells,
				Er = Sr.clearHovered,
				Cr = (Sr.setMoveAdded, Sr.fillAreaCells),
				Mr = Sr.ourOccupied,
				Or = Sr.enemyOccupied,
				Nr = Sr.clearMatrix;
			const Dr = xr,
			...
			const jr = function (t) {
				...
				return (
					...
					e.createElement(e.Fragment, null, e.createElement(zr, null, s))
				);
			};
			var Ar,
				Ir = dr({
					name: 'timerData',
					initialState: { timer: !1 },
					reducers: {
			...
			function Hr(t) {
				...
				return (
					...
					(u.onGetClickedCell = function (e, n) {
					...
					e.createElement(
						Br,
						null,
						e.createElement(Wr, null, e.createElement(kt, null, 'Enemy Field')),
						e.createElement(
							'div',
			...
			function Vr(t) {
				...
				return (
					...
					e.createElement(
						Br,
						null,
						e.createElement(Wr, null, e.createElement(kt, null, 'Our Field')),
						e.createElement(
							'div',
							{ style: { position: 'relative' } },
							e.createElement('div', { ref: a }),
							e.createElement(Tt, { player: 'our' }),
						),
					)
				);
			}
			function $r(t) {
				...
				return e.createElement(
					...
					e.createElement(
						Mt,
						{ width: 310 },
						e.createElement(kt, null, n ? 'Your Turn' : 'Next player goes'),
						e.createElement(jr, {
							count: 15,
							endTimer: function () {
					...
					e.createElement(
						e.Fragment,
						null,
						e.createElement(Vr, { shipsImages: t.shipsImages }),
						e.createElement(Hr, { shipsImages: t.shipsImages, socket: t.socket }),
					),
				);
			}
			var Yr = it.h1(
				...
				return (
					...
					e.createElement(
						...
						e.createElement(
							Mt,
							null,
							e.createElement(Gr, { textAlign: 'center' }, 'Battleship'),
							e.createElement(kt, { textAlign: 'center' }, 'Please, write your name'),
							e.createElement(
								'form',
								null,
								e.createElement(
									...
									c ? e.createElement(po, { type: y }, h) : '',
									e.createElement(kt, { textAlign: 'center' }, 'Please, write your password'),
									e.createElement(so, {
										handlerChange: function (e) {
								...
								e.createElement(
									ro,
									{
										onClick: function (e) {
											e.preventDefault(),
												o.length < 5
													? (f(!0), v('name'), m('Minimum 5 characters'))
													: l.length < 5
														? (f(!0), v('password'), m('Minimum 5 characters'))
														: n.reg({ name: o, password: l });
										},
									},
									'Submit',
								),
			...
			var Ho = dr({
					...
					reducers: {
						...
						changeField: function (e, t) {
							...
							'ourField' === r
								? (e.ourOccupiedCell = { position: o, status: a })
								: (e.enemyOccupiedCell = { position: o, status: a }),
								(e[r] = i);
						},
					},
				}),
			...
			var Ko = (function () {
				function e() {
					(this.sound = { volume: 0.5, isSound: !0 }),
						(this.music = { volume: 0.5, isSound: !1 }),
				...
				return (
					...
					(e.prototype.updateSetting = function (e, t) {
						'music' === e ? (this.music = Object.assign(t)) : (this.sound = Object.assign(t)),
							this.music.isSound ? this.playMusic() : this.musicAudio.pause();
					}),
			...
			var ea = dr({
				...
				ia = ta.setAutoPut,
				la = ta.setDecShip,
				ua = (ta.randomRotate, ta.rotateInput),
			...
			var fa = (function () {
								...
								switch ((console.log(r.type), r.type)) {
									...
									case 'start_game':
										...
										var f = JSON.parse(r.data),
											d = f.ships,
											p = f.currentPlayerIndex,
											h = vo();
										d.forEach(function (e) {
											for (var t = 0; t < e.length; t++)
												e.direction
													? (h[e.position.y + t][e.position.x] = 2)
													: (h[e.position.y][e.position.x + t] = 2);
										}),
											t(Go({ field: h })),
											t(Co({ isCurrentPlayer: p === n.playerIdx }));
										break;
									case 'reg':
										var m = JSON.parse(o),
											g = m.name,
											...
											v = m.errorText;
										y
											? t(Oo({ error: y, errorText: v }))
											: (t(xo({ name: g })),
												t(Oo({ error: y, errorText: '' })),
												t(Bo({ page: 'room' })));
										break;
									case 'update_room':
										var b = JSON.parse(o);
									...
									case 'create_game':
										...
										(n.playerIdx = x),
											t(ko({ index: x })),
											t(Eo({ idGame: k })),
											t(Bo({ page: 'chooseShip' }));
										break;
									case 'finish':
										var E = JSON.parse(o).winPlayer;
										setTimeout(function () {
											t(Mo({ winner: E === n.playerIdx })),
												t(Bo({ page: 'finishGame' })),
												t(Zo()),
												t(sa()),
												t(Nr());
										}, 1e3);
					...
					return (
						...
						(e.prototype.attack = function (e, t, n) {
							this.sendMessage(
								'attack',
								JSON.stringify({ x: e, y: t, gameId: n, indexPlayer: this.playerIdx }),
							);
						}),
						(e.prototype.randomAttack = function (e) {
							this.sendMessage(
								'randomAttack',
								JSON.stringify({ gameId: e, indexPlayer: this.playerIdx }),
							);
						}),
						...
						(e.prototype.startGame = function (e, t) {
							this.sendMessage(
								'add_ships',
								JSON.stringify({ gameId: e, ships: t, indexPlayer: this.playerIdx }),
							);
						}),
				...
				var n = t.socket,
					...
					o = r.length
						? e.createElement(
								da,
								null,
								e.createElement(kt, null, 'Rooms in game'),
								r.map(function (t, r) {
									return e.createElement(
										'div',
										{ key: r },
				...
				var t = p(function (e) {
					...
					n = t.length
						? e.createElement(
								ga,
								null,
								e.createElement(kt, null, 'Best players'),
								e.createElement(
									ya,
									null,
									e.createElement(
										...
										e.createElement(
											'tr',
											{ key: 0 },
											e.createElement(ba, null, 'N'),
											e.createElement(ba, null, 'Name'),
											e.createElement(ba, null, 'Poins'),
										),
									),
									t.map(function (t, n) {
										return e.createElement(
											...
											e.createElement(
												'tr',
												{ key: n + 1 },
												e.createElement(va, null, n + 1),
												e.createElement(va, null, t.name),
												e.createElement(va, null, t.wins),
											),
										);
									}),
								),
					...
					return e.createElement(
						...
						e.createElement(
							...
							e.createElement(
								'div',
								null,
								e.createElement(kt, null, 'Welcome to Battleship, ', r),
								e.createElement(kt, null, 'What game do you choose?'),
								e.createElement(
									ao,
									{
										onClick: function () {
				...
				Ma = function () {
					...
					return e.createElement(
						...
						e.createElement(
							Mt,
							null,
							e.createElement(Gr, { textAlign: 'center' }, t ? 'You Winner' : 'You loser'),
							e.createElement(
								ro,
								{
									onClick: function () {
			...
			const Ia = function (t) {
				...
				return e.createElement(
					ja,
					null,
					Object.entries(r).map(function (t, n) {
						var r = 'Count:' + t[1];
						return e.createElement(
							Aa,
							{ key: n },
			...
			var Ta,
				...
				_a = (function () {
					...
					return (
						(e.prototype.start = function (e) {
							(this.matrix = e),
								(this.notRotatedAreas = this.arrayDataFromArray('horizont', e)),
								(this.rotatedAreas = this.arrayDataFromArray('vertical', e));
						}),
						...
						(e.prototype.arrToSubArr = function (e) {
							for (var t = [], n = [], r = 0; r < e.length; r++)
								n.length
									? this.isNext(n[n.length - 1], e[r])
										? n.push(e[r])
										: (t.push(n), (n = []).push(e[r]))
									: n.push(e[r]),
									r + 1 === e.length && n.length && t.push(n);
							return t;
						}),
						(e.prototype.axisData = function (e, t) {
							for (var n = [], r = 0; r < t.length; r++) {
								for (var o = [], a = 0; a < t[0].length; a++)
									0 === ('vertical' === e ? t[a][r] : t[r][a]) && o.push(a);
						...
						(e.prototype.arrayDataFromArray = function (e, t) {
							var n = this,
								r = [];
							return (
								this.axisData(e, t).forEach(function (e, t) {
									var o = n.longerSub(e);
						...
						(e.prototype.apdateEmptyAreas = function (e, t) {
							var n = 'y' === e ? this.notRotatedAreas : this.rotatedAreas,
								r = n.find(function (e) {
									return e.id == +t[0];
								}),
								o = n.indexOf(r),
								a = new Set(t[1].split('-')),
								i = this.elementsHasntInSet(r, a),
								l = this.arrToSubArr(i),
								u = this.longerSub(l);
							n.splice(o, 1, { id: r.id, data: this.arrToSubArr(i), longer: u }),
								(r.data = this.arrToSubArr(i)),
								(r.longer = u);
						}),
						...
						(e.prototype.occupateArea = function (e) {
							...
							Array.from(e).forEach(function (e) {
								...
								this.deleteFromEmptyAreas('x', n),
								this.deleteFromEmptyAreas('y', t);
						}),
						(e.prototype.generateRandomShip = function (e, t, n) {
							var r = (
									n
										? JSON.parse(JSON.stringify(this.rotatedAreas))
										: JSON.parse(JSON.stringify(this.notRotatedAreas))
								).filter(function (e) {
									return e.longer >= t;
								}),
								o = Math.round(Math.random() * (r.length - 1)),
								a = r[o].data.find(function (e) {
									return e.length >= t;
								}),
				...
				Ra = (function () {
					function e(e) {
						...
						(this.botShips = []),
							(this.ships = null),
							(this.isRandomActive = !1),
							(this.generator = null),
							(this.emptyAreas = new _a()),
							(this.emptyAreas.onGetCoordinates = function (n, r, o, a) {
								e
									? t.botShips.push({ type: n, y: r, x: o, isRotate: a })
									: t.onGetCoordinates(n, r, o, a);
							});
					}
					return (
						(e.prototype.genShipsToAuto = function () {
							var e, t;
							return (function (e, t) {
								var n,
									r,
								...
								switch (n.label) {
									case 0:
										(e = []),
											Object.entries(this.ships).forEach(function (t) {
						...
						(e.prototype.putRandomShips = function (e, t) {
							for (
								this.ships = e, this.emptyValues(t), this.generator = this.genShipsToAuto();
								this.interval();
			...
			var Ua = (function () {
				function e(e, t) {
					(this.circleSteps = [
						...
						(this.intersectionController = e),
						(this.boardMatrix = t);
				}
				return (
					(e.prototype.fillArea = function (e, t) {
						return (
							this.boardMatrix.valueToCell(e, t, 'blocked'),
							this.intersectionController.addToIntersection(''.concat(e, '-').concat(t)),
							''.concat(e, '-').concat(t)
						);
					}),
					(e.prototype.circleStepsFill = function (e, t) {
						var n = this,
							r = [];
						return (
							this.circleSteps.forEach(function (o) {
								e + o.y < 0 ||
									e + o.y >= n.boardMatrix.matrixLength() ||
									t + o.x < 0 ||
									t + o.x >= n.boardMatrix.matrixLength() ||
									r.push(n.fillArea(e + o.y, t + o.x));
							}),
							r
						);
					}),
			...
			var Ba = (function () {
				...
				return (
					(e.prototype.isIntersection = function (e, t, n, r) {
						for (var o = [], a = 0; a < n; a++)
							r
								? o.push(this.intersectionData.has(''.concat(t + a, '-').concat(e)))
								: o.push(this.intersectionData.has(''.concat(t, '-').concat(e + a)));
					...
					(e.prototype.iterAddToIntersection = function (e, t, n, r) {
						if (r)
							for (o = t; o < n; o++) this.intersectionData.add(''.concat(t + o, '-').concat(e));
						else
							for (var o = 0; o < n; o++)
								this.intersectionData.add(''.concat(t, '-').concat(e + o));
					}),
			...
			var Ha = (function () {
				function e(e) {
					var t = this;
					(this.intersectionController = new Wa()),
						(this.fillComponent = new Qa(this.intersectionController, e)),
						(this.fillComponent.onFillArea = function (e) {
							t.onFillShipArea(e);
						}),
						(this.boardMatrix = e),
						(this.isMovesLisen = !1),
						(this.isListenCkick = !1),
						this.isMovesLisen || (this.isMovesLisen = !0);
				}
				return (
					(e.prototype.addShipToCanvasmage = function (e, t, n, r, o) {
						return (
							this.intersectionController.iterAddToIntersection(e, t, n, r),
							this.boardMatrix.clearCells(),
							this.fillComponent.fillShipArea(e, t, n || n, r),
							{ xC: e, yC: t, isRotate: r, type: o }
						);
					}),
					...
					(e.prototype.onMove = function (e, t, n, r) {
						...
						if (this.boardMatrix.isOnBoard(e, t, n, r)) {
							(this.x = e), (this.y = t);
							var o = this.intersectionController.isIntersection(e, t, n, r),
								a = o ? 'occupate' : 'hovered';
							return (
								(this.isListenCkick = !o),
								this.boardMatrix.fillCell(a, e, t, n, r),
								o || (!o && !this.isListenCkick)
							);
						}
					}),
				...
				Ya = (function (e) {
					function t(t, n, r, o, a, i, l, u, s) {
						...
						return (
							...
							(c.isRotated = !1),
							(c.activeShip = a),
							(c.activeSize = Oa[c.activeShip]),
							(c.board = r),
							(c.boardMatrix = new L(c.board)),
							(c.boardComponent = new D(c.node, 10, 10, c.boardMatrix.cellSize, l)),
							(c.boardMatrix.onClearHovered = function (e) {
							...
							(c.onAddShip = s),
							(c.parentNode = t),
							(c.createEmptyValues = !1),
							(c.moveBinded = c.onMove.bind(c)),
							(c.clickBinded = c.onClick.bind(c)),
							(c.rotateShipBinded = c.rotateShip.bind(c)),
							(c.canvasSectionController = new Va(c.boardMatrix)),
							(c.canvasSectionController.onAddShip = function (e) {
								return c.onAddShip(e);
							}),
							(c.canvasSectionController.onFillShipArea = function (e) {
								c.isRandomMode && c.randomShips.occupateCells(e),
									c.onFillShipArea(e, c.boardMatrix.getBlockValue());
							}),
							c.boardComponent.drawScene(c.board, c.shipsOnCanvas),
							(c.randomShips = new Fa()),
							(c.randomShips.onGetCoordinates = function (e, t, n, r) {
								var o = Oa[e];
								c.canvasSectionController.addShipImg(n, t, o, r, e);
							}),
							(c.boardComponent.canvas.onmousemove = c.moveBinded),
							c
						);
					}
					return (
						$a(t, e),
						(t.prototype.autoPutShips = function (e, t) {
							(this.isRandomMode = !0),
								(this.isRotated = null),
								this.randomShips.putRandomShips(e, t);
						}),
						(t.prototype.onClick = function (e) {
							var t = this.boardMatrix.getCursorPosition(e, this.boardComponent.node),
								n = t.x,
								r = t.y;
							this.boardComponent.canvas.removeEventListener('mousemove', this.moveBinded),
								...
								this.canvasSectionController.onClick(
									n,
									r,
									this.activeSize,
									this.isRotated,
						...
						(t.prototype.onMove = function (e) {
							var t = this.boardMatrix.getCursorPosition(e, this.boardComponent.node),
								n = t.x,
								r = t.y;
							this.canvasSectionController.onMove(n, r, this.activeSize, this.isRotated)
								? (document.body.removeEventListener('keyup', this.rotateShipBinded),
									this.boardComponent.canvas.removeEventListener('click', this.clickBinded))
						...
						(t.prototype.updateBoard = function (e) {
							(this.board = e),
								this.boardMatrix.updateBoard(e),
								this.boardComponent.drawScene(this.board, this.shipsOnCanvas);
						}),
			...
			var Za = function (t) {
					...
					return (
						(0, e.useEffect)(function () {
							if (c) c.destroy();
								...
								var e = new Ga(r.current, d, h, i, l, a, n, u, function (e) {
									qo.playAudio('miss'),
										o(oa({ ship: JSON.stringify(e), active: l })),
										o(aa(null)),
										o(la(e.type));
								});
								f(e),
									(e.onRotateShip = function () {
										return o(ra());
									}),
						...
						e.createElement(e.Fragment, null, e.createElement('div', { ref: r }))
					);
				},
				Ja = function (e, t) {
					return (
			...
			const ti = function (t) {
				var n = t.handleChange,
					r = t.before,
					o = t.after;
				return e.createElement(
					Ka,
					null,
					e.createElement(ei, null, r),
					e.createElement(Xa, { type: 'checkbox', onChange: n }),
					e.createElement(qa, null),
					e.createElement(ei, null, o),
				);
			};
			var ni, ri, oi, ai;
			const ii = function (t) {
						...
						e.createElement(
							...
							e.createElement(
								...
								e.createElement(
									'div',
									{ ref: o },
									e.createElement(kt, null, 'Arrange your ships on grid'),
									e.createElement(jr, {
										count: 59,
										endTimer: function () {
											a(ia());
							...
							e.createElement('div', null, e.createElement(Za, { imagesObj: n })),
						)
					);
				},
				li = function (t) {
						...
						e.createElement(ii, {
							...
							onStartGame: function () {
								var e = a.map(function (e) {
									return {
										position: { x: e.xC, y: e.yC },
										direction: !!e.isRotate,
										type: e.type,
										length: Oa[e.type],
									};
								});
				...
				return e.createElement(
					...
					e.createElement(
						...
						e.createElement('source', {
							src: '../../public/assets/mp4/bg3-1.mp4',
							type: 'video/mp4',
						}),
					),
					n,
			...
			const Ci = function (t) {
				...
				return e.createElement(
					xi,
					{ htmlFor: o },
					e.createElement(Ei, { type: 'checkbox', checked: n, onChange: r, id: o }),
			...
			const Ti = function (t) {
				...
				return e.createElement(
					Ai,
					{ isSound: r },
					e.createElement(Ii, { src: o, alt: 'icon', scale: a }),
				);
			};
			var Li,
				_i,
			...
			const Ui = function (t) {
				var n = t.type,
					r = (0, e.useState)(Object.assign(qo.getSetting(n))),
					o = r[0],
					a = r[1];
				return (
					(0, e.useEffect)(
					...
					e.createElement(
						Fi,
						null,
						e.createElement(Ti, { type: n, isSound: o.isSound }),
						e.createElement(kt, null, n),
						e.createElement(Ci, {
							isSound: o.isSound,
							type: n,
							handleChange: function (e) {
				...
				var t = (0, e.useState)(!1),
					...
					a = e.createElement(
						...
						e.createElement(
							...
							e.createElement(Ui, { type: 'sound' }),
							e.createElement(Ui, { type: 'music' }),
							e.createElement(
								lo,
								{ onClick: o },
								e.createElement(Vi, {
			...
			var Yi,
				...
				Ji = (function (e) {
					var t,
						n = function (e) {
							return (function (e) {
								...
								var t = e.thunk,
									n = void 0 === t || t,
									r = (e.immutableCheck, e.serializableCheck, new ur());
								return (
									n &&
										((function (e) {
							...
							try {
								!(function (e) {
									Object.keys(e).forEach(function (t) {
										...
										if (void 0 === n(void 0, { type: Bn.PROBE_UNKNOWN_ACTION() }))
					...
					var m = $n.apply(void 0, h),
						g = Vn;
					s && (g = lr(ar({ trace: !1 }, 'object' == typeof s && s)));
					var y = [m];
					return (
						Array.isArray(p) ? (y = Kn([m], p)) : 'function' == typeof p && (y = p(y)),
						Hn(t, f, g.apply(void 0, y))
					);
				})({
					reducer: {
						userData: No,
			...
			const Ki = Ji;
			t.s(document.body).render(
				e.createElement(
					function ({ store: t, context: n, children: r, serverState: o }) {
						const a = (0, e.useMemo)(() => {
					...
					e.createElement(function () {
						...
						return (
							(0, e.useEffect)(
								function () {
									'room' === f && i(e.createElement(Ca, { socket: n })),
										'chooseShip' === f && i(e.createElement(li, { imagesObj: u, socket: n })),
										'gameField' === f &&
											i(
												e.createElement(
													e.Fragment,
													null,
													e.createElement($r, { socket: n, shipsImages: u }),
												),
											),
							...
							(0, e.useEffect)(function () {
								var t, n;
								(t = 30),
									(n = { small: 30, medium: 60, large: 90, huge: 120 }),
							...
							(0, e.useEffect)(function () {
								var e = localStorage.getItem('sound')
									? JSON.parse(localStorage.getItem('sound'))
									: { volume: 0.5, isSound: !0 };
								'number' == typeof e.volume &&
									e.volume >= 0 &&
									e.volume <= 1 &&
									'boolean' == typeof e.isSound &&
									qo.updateSetting('sound', { volume: e.volume, isSound: e.isSound });
								var t = localStorage.getItem('music')
									? JSON.parse(localStorage.getItem('music'))
									: { volume: 0.5, isSound: !1 };
								'number' == typeof t.volume &&
									t.volume >= 0 &&
									t.volume <= 1 &&
									'boolean' == typeof t.isSound &&
									qo.updateSetting('music', { volume: t.volume, isSound: t.isSound });
							}, []),
